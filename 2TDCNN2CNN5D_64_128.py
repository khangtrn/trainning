            ...
            for kernel_size_2 in kernel_sizes:
                for kernel_size_3 in kernel_sizes:
                    for kernel_size_4 in kernel_sizes:
                        ...
                        results[f"2TDCNN2CNN5D_{filter_1}_{filter_2}_{filter_3}_{filter_4}_{kernel_size_1}_{kernel_size_2}_{kernel_size_3}_{kernel_size_4}_loss"] = result[0]
                        results[f"2TDCNN2CNN5D_{filter_1}_{filter_2}_{filter_3}_{filter_4}_{kernel_size_1}_{kernel_size_2}_{kernel_size_3}_{kernel_size_4}_acc"] = result[1]

with open(f"2TDCNN2CNN5D_{filter_1}_{filter_2}.json", "w") as outfile:
